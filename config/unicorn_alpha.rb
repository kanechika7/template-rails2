...
# log 
stderr_path 'log/unicorn_alpha.log'
stdout_path 'log/unicorn_alpha.log'
...
before_fork do |server, worker|
 ...
 old_pid = RAILS_ROOT + '/tmp/pids/unicorn_alpha.pid.oldbin'
