...
# log 
stderr_path 'log/unicorn_beta_m.log'
stdout_path 'log/unicorn_beta_m.log'
...
before_fork do |server, worker|
 ...
 old_pid = RAILS_ROOT + '/tmp/pids/unicorn_beta_m.pid.oldbin'
